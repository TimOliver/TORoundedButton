...
* Added unit tests to check consistent initial behaviour.
* Updated the documentation in the header to match expected default values.

### Fixed

* A bug where the dynamic text size would not properly restore.
